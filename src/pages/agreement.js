  ...
  return (
    <section className="Agreement" >
      ...
      <div className="container p-2 mt-4 align-top">
        ...
        <form>
          <p>This Dispatcher Agency Agreement (AGREEMENT) is made on <input type="date" />
            ...
            Carrier:    <input type="text" placeholder="Carrier" /><br /><br /><br /><br />




            This Dispatcher Agency Agreement (AGREEMENT) is made on <input type="date" />
            by and between Truckage Dispatch LLC, (hereinafter referred to as 'DISPATCH'), and <input type="text" placeholder="Name" />
            of <select>
            ...
            I * <input type="text" placeholder="First Name" /><br />
            <input type="text" placeholder="Second Name" /><br />
            <input type="text" placeholder="Last Name" />
            the owner of <input type="text" placeholder="Company" /><br /><br />
