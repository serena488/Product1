                ...
                <Container className="border text-center mt-4">
                    ...
                    <Accordion flush className="mt-4 my-4">
                        ...
                        <Accordion.Item eventKey="0">
                            ...
                            <Accordion.Header><h5><FaQuora className="me-2" color="#ED1C24" fontSize="27px" />: Do I need to fill out the contract to start working with you?
                            </h5></Accordion.Header>
                        ...
                        <Accordion.Item eventKey="1">
                            <Accordion.Header ><h5><FaQuora className="me-2" color="#ED1C24" fontSize="27px" />:  What happens If I don’t want to take the load that you have offered?</h5></Accordion.Header>
                            <Accordion.Body className="bodys">
                        ...
                        <Accordion.Item eventKey="2">
                            <Accordion.Header ><h5><FaQuora className="me-2" color="#ED1C24" fontSize="27px" />:  Do I need to fill out any broker-created packages for brokers I have never done business
                        ...
                        <Accordion.Item eventKey="3">
                            <Accordion.Header ><h5><FaQuora className="me-2" color="#ED1C24" fontSize="27px" />: Do you have any knowledge of what brokers are legit (Good or Bad)?</h5></Accordion.Header>
                            <Accordion.Body className="bodys">
                            We only do business with brokers who are reputable and who we know will pay you.
                            </Accordion.Body>
                        </Accordion.Item>
                        <Accordion.Item eventKey="4">
                            <Accordion.Header ><h5><FaQuora className="me-2" color="#ED1C24" fontSize="27px" />: What do you require from me to start working?</h5></Accordion.Header>
                            <Accordion.Body className="bodys">
                        ...
                        <Accordion.Item eventKey="5">
                            <Accordion.Header ><h5><FaQuora className="me-2" color="#ED1C24" fontSize="27px" />: How can I get paid?</h5></Accordion.Header>
                            <Accordion.Body className="bodys">
